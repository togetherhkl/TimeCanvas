<template>
    ...
    <div>
      <iframe src="https://juejin.cn/s/vue%20webview%E7%BB%84%E4%BB%B6" width="800" height="600"></iframe>
    </div>
    <div>
      <video ref="videoPlayer" class="video-js vjs-default-skin" controls width="800px">
