  ...
  <div class="header">
    <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" :ellipsis="false"
      ...
      <el-sub-menu index="4">
        ...
        <el-menu-item index="4-1" @click="openDrawer('同学录')">同学录</el-menu-item>
        <el-menu-item index="4-2" @click="openDrawer('趣事录')">趣事录</el-menu-item>
        <el-menu-item index="4-3" @click="openDrawer('旅游志')">旅游志</el-menu-item>
      </el-sub-menu>
