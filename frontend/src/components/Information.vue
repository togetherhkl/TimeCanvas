<!-- <template>
    <div class="information-container">
        <div class="classmate-image">
            <img src="../assets/1.png" style="width: 170px; height: 200px; border-radius: 50%;" alt="同学录头像">
        </div>
