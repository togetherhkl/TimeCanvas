...
import uvicorn
from routers import users,classmate, baidufile, xunfei, album, statistics, interestingevent, travel, video
...
app.include_router(video.router)#将video.py中的路由添加到app中
